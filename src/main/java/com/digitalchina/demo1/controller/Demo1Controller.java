 ...
 * 
 */
package com.digitalchina.demo1.controller;
...
import com.digitalchina.demo1.util.HttpClientUtil;
...
public class Demo1Controller {
  ...
  public String main(HttpServletRequest request, HttpServletResponse response) throws IOException{
    ...
    //sso登录
    response.sendRedirect("http://sso.x.com/sso?gotoUrl=http://demo1.x.com/demo1/main");
    return null;
  }
}
